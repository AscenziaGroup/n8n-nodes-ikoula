	...
	description: INodeTypeDescription = {
		...
		properties: [
				...
				options: [
					{
						name: 'SSL',
						value: 'ssl',
						description: 'Manage SSL certificate service',
					},
				],
				default: 'ssl',
			},
				...
				options: [
					{
						...
						description: 'Get the details of a SSL subscription',
						action: 'Get subscription details',
					},
					{
						name: 'List Subscriptions',
						value: 'listSubscriptions',
						description: 'Lists SSL subscriptions',
			...
			},
			{
				...
				default: 0,
				description: 'The ID of the SSL subscription',
			},
			{
