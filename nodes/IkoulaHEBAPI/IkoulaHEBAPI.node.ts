...
export class IkoulaHebApi implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Ikoula HEB API',
		name: 'ikoulaHebApi',
		...
		properties: [
				...
				options: [
					{
						name: 'HEB',
						value: 'heb',
						description: 'Manage web hosting service',
					},
				],
				default: 'heb',
			},
				...
				options: [
					{
						...
						description: 'Get details of a specific HEB account',
						action: 'Get account details',
					},
					{
						name: 'List Accounts',
						value: 'listAccounts',
						description: 'List all HEB accounts',
			...
			},
			{
				...
				default: 0,
				description: 'The ID of the HEB service subscription',
			},
			{
