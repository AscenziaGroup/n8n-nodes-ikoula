	...
	description: INodeTypeDescription = {
		...
		properties: [
				...
				options: [
					{
						name: 'Plesk',
						value: 'plesk',
						description: 'Manage Plesk managed hosting service',
					},
				],
				default: 'plesk',
			},
				...
				options: [
					{
						...
						description: 'Get details of a specific Plesk managed service',
						action: 'Get service details',
					},
					{
						name: 'List Services',
						value: 'listServices',
						description: 'List all Plesk managed services',
			...
			},
			{
				...
				default: 0,
				description: 'The ID of the Plesk managed service subscription',
			},
			{
